...
export default function RootLayout({
    ...
    return (
        <html lang="ja" >
            <head>
                <title>{"つながるラボ"}</title>
                <meta name="description" content="つながるラボは中四国地方専用のオンラインコミュニティです。フリーランス、経営者、大学生、独立を目指す方が集まり、人脈作りやスキルアップ、集客、地域課題解決に取り組みます。無料プランから始められ、イベントやセミナーも充実！LINE登録でお得なキャンペーン実施中！"/>
